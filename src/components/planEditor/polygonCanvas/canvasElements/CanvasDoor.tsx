...
import { dragPoint } from "./CanvasPoint";
...
export default function CanvasDoor({
	door,
	wall,
	canvasRatio,
	scale,
	...
	const handleDragMove = (
		...
		circle: string,
		handleSnapLinesChange: (guideLines: SnapLine[]) => void,
	) => {
		...
		const newPos = dragPoint(
			pointToChange,
			initialPosition,
			e,
			handleSnapLinesChange,
		);
		const { x: projectedX, y: projectedY } = projectPointToLineSegment(
